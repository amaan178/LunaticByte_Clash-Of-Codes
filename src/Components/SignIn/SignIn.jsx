          ...
          <div class="form_container">
                ...
                <div class="input_container">
                  <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon">
                    ...
                    <input placeholder="Full Name" title="Inpit title"  name="name" type="text" class="input_field" onChange={handleInputs} id="name_field"/>
                </div>
                <div class="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title"  name="email" type="text" onChange={handleInputs} class="input_field" id="email_field"/>
                </div>
                <div class="input_container">
                    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
                    ...
                    <input placeholder="Password" title="Inpit title" name="password" onChange={handleInputs} type="password" class="input_field" id="password_field"/>
                </div>
                <button title="Sign In" type="submit" class="sign-in_btn" onClick={handleSubmit}>
                    <span>Sign In</span>
                </button>
            </div>
    </div>
