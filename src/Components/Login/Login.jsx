...
function Login() {
  ...
  const handleOnClick = () => navigate('/sign-up');
  return (
    <div className="container_login">
            <div className="form_container_login">
                <div className="title_container_login">
                    <p className="title_login">Login</p>
                    <span className="subtitle_login">Please Login to continue</span>
                </div>
                <br/>
                <div className="input_container_login">
                    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="icon_login">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="email" type="text"   onChange={(event) => handleInputs(event)} className="input_field_login" id="email_field"/>
                </div>
                <div className="input_container_login">
                    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="icon_login">
                    ...
                    <input placeholder="Password" title="Inpit title" name="password" type="password"   onChange={(event) => handleInputs(event)} className="input_field_login" id="password_field"/>
                </div>
                <button title="Sign In" type="submit" className="sign-in_btn_login"  onClick={handleSubmit}>
                    <span>Sign In</span>
                </button>
                <div className="separator_login">
                    <hr className="line"/>
                    <span>Or</span>
                    <hr className="line"/>
                </div>
                <button title="Sign In" className="sign-in_ggl_login" onClick={handleOnClick}>
                    <span>Don't have an account? Click here to create one</span>
                </button>
                <p className="note_login">Terms of use &amp; Conditions</p>
            </div>
        </div>
  );
}
