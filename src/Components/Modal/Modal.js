    ...
    <div className="modal-wrapper" aria-modal aria-hidden tabIndex={-1} role="dialog">
      <div className="modal">
        ...
        <div class="input_container_signup">
            ...
            <input placeholder="name@mail.com" title="Inpit title"  name="email" type="text" class="input_field_signup" id="email_field"/>
        </div>
        <div class="input_container_signup">
        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="icon_login">
            ...
            <input placeholder="enter package details" title="Inpit title"  name="email" type="text" class="input_field_signup" id="email_field"/>
        </div>
